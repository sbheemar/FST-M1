...
public class GitHubProject {
    ...
    String sshKey = "ssh-ed25519 AAAAC3NzaC1lZDI1NTE6BBBAIMB0P2aZe1Kp51Cmvl+TTjOwfr6sNlGCSlIZQqbAGS6N azuread\\sanjayb@LAPTOP-OL6SG7C7";
    int sshKeyId;

    // Request specification
    RequestSpecification requestSpec = new RequestSpecBuilder().
            setBaseUri("https://api.github.com/user/keys").
            addHeader("Authorization", "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").
